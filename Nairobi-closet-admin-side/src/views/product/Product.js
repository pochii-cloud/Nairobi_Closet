          ...
          <CCardBody>
            <CTable striped>
              <CTableBody>
                ...
                <CTableRow>
                  <CTableDataCell className="py-4">Available colors </CTableDataCell>
                  <CTableDataCell className="py-4">{product.colors}</CTableDataCell>
                </CTableRow>
                <CTableRow>
                  <CTableDataCell className="py-4">Available Sizes </CTableDataCell>
                  <CTableDataCell className="py-4">{product.sizes}</CTableDataCell>
                </CTableRow>
                <CTableRow>
