...
const User = () => {
              ...
              <CCol md={6} className="border p-2">
                ...
                <p>
                  <span className="strong">
                    ...
                    Phone Number : {order.shippingAddress && order.shippingAddress.postalCode}
                  </span>
                </p>
                <p>
                ...
                <p>
                  <span className="strong">
                    Order address : {order.shippingAddress && order.shippingAddress.address}
                  </span>
                </p>
              </CCol>
              <CCol md={6} className="border p-2">
                <h6>Order Instructions</h6>
                    ...
                    {order.orderItems &&
                      order.orderItems.map((data, index) => (
                        ...
                        <CTableRow key={index}>
                          ...
                          <CTableDataCell>{data.colors}</CTableDataCell>
                          <CTableDataCell>{data.sizes}</CTableDataCell>
                          <CTableDataCell>
                            {symbol}
                            {data.price}
                          </CTableDataCell>
  ...
  {order.orderItems &&
    order.orderItems.map((data, index) => {
      console.log("This is how data looks like:", data)// Add console.log statement here
      return (
        <CTableRow key={index}>
          <CTableHeaderCell scope="row">1</CTableHeaderCell>
          <CTableDataCell>{data.name}</CTableDataCell>
          <CTableDataCell>
            <CImage src={UPLOAD_URL + data.image} className="img-fluid" height="150" width="150" />
          </CTableDataCell>
          <CTableDataCell>{data.colors}</CTableDataCell>
          <CTableDataCell>{data.sizes}</CTableDataCell>
          <CTableDataCell>
