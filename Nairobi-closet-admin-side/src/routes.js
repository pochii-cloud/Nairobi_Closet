...
const routes = [
  ...
  // =================PRODUCT ROUTES ENDS=====================================
  // =================Blogs ROUTES STARTS===================================
  { path: '/bogs', name: 'Blogs', element: Blogs, exact: true },
  { path: '/blog/add', name: 'Add Blog', element: AddBlog, exact: true },
  { path: '/blog/:id/edit', name: 'Edit Blog', element: AddBlog, exact: true },
