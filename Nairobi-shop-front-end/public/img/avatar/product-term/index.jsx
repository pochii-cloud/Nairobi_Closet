...
function SingleTermProduct() {
  ...
  useEffect(() => {
    const getProductBySearchText = async () => {
      try {
        console.log(data)
        const { data } = await http.get(`/api/v1/home/product?search=${encodeURIComponent(searchText)}`);
        console.log(data)
        setProduct(data);
      } catch (e) {
  ...
  return (
                ...
                <div className="row">
                  ...
                  <div className="col-md-12">
                    <div className="feature-box">
                      ...
                      <p>
                      Get difference refunded if you find it cheaper anywhere else.</p>
</div>
</div>
</div>
</div>
   ...
   <div className="col-lg-12 col-md-12">
      ...
      <div className="text-center">No search item found.</div>
    )}
  </div>
</section>  </div>
);
}
export default SingleTermProduct;
